...
<head>
    ...
    <link rel="shortcut icon" href="{{ asset('images/logo.jpeg') }}" type="image/webp">
...
<body>
    <div x-data="{ cartOpen: false, isOpen: false, openProfile: false }">
        <nav class="container bg-gray-100 mx-auto px-6 py-5">
            <div class="w-full grid grid-cols-2">
                ...
                <div class="relative flex justify-center items-center">
                    <div class="absolute left-0 top-0">
                        <img class="w-auto rounded-md h-10" src="{{ asset('images/logo.jpeg') }}" alt="Your Company">
                    </div>
                    <div class="ml-28">
                        <a href="#"
        ...
        <div class="container mx-auto px-6 bg-gray-100">
